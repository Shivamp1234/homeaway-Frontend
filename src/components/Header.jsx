    ...
    <>
      <header className="p-5 flex justify-between">
        <Link to="/" className="flex items-center gap-1">
          ...
          <h1 className="font-bold text-xl">homeaway</h1>
        </Link>
        ...
        <Link
          to="/login"
          className="flex items-center gap-4 border border-gray-300 rounded-full px-4 py-2 cursor-pointer hover:shadow-md shadow-gray-700"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
